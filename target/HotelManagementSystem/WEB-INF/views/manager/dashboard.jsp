    ...
    <main class="main-panel" id="dashboard-content">
        ...
        <div class="content dashboard-content">
            <section class="dashboard-hero" aria-labelledby="dashboard-welcome">
                <p class="dashboard-kicker">MANAGER HOME</p>
                <c:choose>
                    <c:when test="${not empty sessionScope.sessionUser.fullName}">
                        ...
                        <p>Chọn một chức năng quản lý để tiếp tục.</p>
                    </c:when>
                    <c:otherwise>
                        <h1 id="dashboard-welcome">Manager Dashboard</h1>
                        <p class="dashboard-user-error" role="alert">Không thể tải thông tin Manager. Bạn vẫn có thể sử dụng các chức năng bên dưới.</p>
                    </c:otherwise>
                </c:choose>
            </section>
            ...
            <section class="dashboard-section" aria-labelledby="management-functions-title">
                <div class="dashboard-section-heading">
                    <div>
                        <h2 id="management-functions-title">Chức năng quản lý</h2>
                        <p>Truy cập nhanh các chức năng thuộc phạm vi Đợt 1.</p>
                    </div>
                </div>
                        ...
                        <c:choose>
                            ...
                            <c:otherwise>
                                <article class="dashboard-card disabled" data-card-id="${card.id}" aria-disabled="true">
                                    ...
                                    <span class="dashboard-card-action">Chưa triển khai</span>
                                </article>
                            </c:otherwise>
                        </c:choose>
                    </c:forEach>
